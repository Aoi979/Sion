#include "../kernels/sm80_sgemm_f32_nn_m128n128k8_cute.cuh"
#include <cuda_ops_core/core.hpp>
#include <cuda_ops_core/registry.hpp>
namespace cuda_ops_core {

Status sm80_sgemm_f32_nn_m128n128k8_cute_launch(
  ...
  sm80_sgemm_f32_nn_m128n128k8_cute_kernel<<<dimGrid, dimBlock, 0, stream>>>(
...
REGISTER_KERNEL(sm80_sgemm_f32_nn_m128n128k8_cute,
                cuda_ops_core::make_sgemm_kernel(
                    "sm80_sgemm_f32_nn_m128n128k8_cute",
                    cuda_ops_core::sm80_sgemm_f32_nn_m128n128k8_cute_launch, false,
                    {.min_cc = 80, .max_cc = 89, .priority = 20},
