...
Status sm80_sgemm_f32_nn_m64n64k8_cute_swizzle_launch(
...
REGISTER_KERNEL(sm80_sgemm_f32_nn_m64n64k8_cute_swizzle,
                cuda_ops_core::make_sgemm_kernel(
                    "sm80_sgemm_f32_nn_m64n64k8_cute_swizzle",
                    cuda_ops_core::sm80_sgemm_f32_nn_m64n64k8_cute_swizzle_launch,
                    false, {.min_cc = 80, .max_cc = 89, .priority = 5},
