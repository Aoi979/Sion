#include "../kernels/sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_db.cuh"
#include <cuda_ops_core/core.hpp>
#include <cuda_ops_core/registry.hpp>
namespace cuda_ops_core {
Status sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_db_launch(
  ...
  cudaError_t err;
  sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_db_kernel<<<dimGrid, dimBlock,
                                                            0, stream>>>(
...
REGISTER_KERNEL(
    sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_db,
    cuda_ops_core::make_sgemm_kernel(
        "sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_db",
        cuda_ops_core::sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_db_launch, false,
        {.min_cc = 80, .max_cc = 89, .priority = 30},
