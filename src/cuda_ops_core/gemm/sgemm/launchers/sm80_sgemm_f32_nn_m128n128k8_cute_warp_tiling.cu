#include "../kernels/sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling.cuh"
#include <cuda_ops_core/core.hpp>
#include <cuda_ops_core/registry.hpp>
namespace cuda_ops_core {
Status sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_launch(
  ...
  err = cudaFuncSetAttribute(
      sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_kernel<
          decltype(prob_shape), decltype(cta_tiler), decltype(dA), decltype(sA),
          decltype(tA), decltype(dB), decltype(sB), decltype(tB), decltype(dC),
          decltype(sC), decltype(tC)>,
  ...
  sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_kernel<<<
      dimGrid, dimBlock, sizeof(float) * cosize_v<decltype(sC)>, stream>>>(
...
REGISTER_KERNEL(sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling,
                cuda_ops_core::make_sgemm_kernel(
                    "sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling",
                    cuda_ops_core::sm80_sgemm_f32_nn_m128n128k8_cute_warp_tiling_launch,
                    false, {.min_cc = 80, .max_cc = 89, .priority = 25},
