...
Status sm80_sgemm_f32_nn_m128n128k8_stage5_one_cta_per_sm_launch(
...
REGISTER_KERNEL(
    ...
    cuda_ops_core::make_sgemm_kernel(
        "sm80_sgemm_f32_nn_m128n128k8_stage5_one_cta_per_sm",
        cuda_ops_core::sm80_sgemm_f32_nn_m128n128k8_stage5_one_cta_per_sm_launch, false,
        {.min_cc = 80,
         .max_cc = 89,
         .priority = 60,
         .required_dynamic_smem_bytes = cutlass_like::kOneCtaPerSmSmemBytes,
         .required_threads_per_block = cutlass_like::kThreads},
        cuda_ops_core::detail::sm80_sgemm_f32_nn_m128n128k8_stage5_metadata()));
