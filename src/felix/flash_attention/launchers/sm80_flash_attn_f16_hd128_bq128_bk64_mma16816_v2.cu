...
FelixStatus sm80_flash_attn_f16_hd128_bq128_bk64_mma16816_v2_launch(
...
REGISTER_KERNEL(
    ...
    felix::make_flash_attn_kernel(
        "sm80_flash_attn_f16_hd128_bq128_bk64_mma16816_v2",
        felix::sm80_flash_attn_f16_hd128_bq128_bk64_mma16816_v2_launch, true,
        {.min_cc = 80,
         .max_cc = 89,
         .priority = 60,
         .required_dynamic_smem_bytes =
             felix::detail::Sm80FlashAttnF16V2Traits<128>::kSmemBytes,
         .required_threads_per_block =
             felix::detail::Sm80FlashAttnF16V2Traits<128>::kThreads},
        {.head_dim = 128,
         .block_q = felix::detail::Sm80FlashAttnF16V2Traits<128>::kBlockQ,
         .block_k = felix::detail::Sm80FlashAttnF16V2Traits<128>::kBlockK,
         .seq_len_multiple =
             felix::detail::Sm80FlashAttnF16V2Traits<128>::kSeqLenMultiple}));
