...
FelixStatus sm80_flash_attn_f16_hd128_bq64_bk64_mma16168_s2_1d_launch(
    half *Q, half *K, half *V, half *O, uint32_t heads, uint32_t batch_size,
    uint32_t seq_len, cudaStream_t stream) {
  return detail::launch_sm80_flash_attn_f16_bq64_bk64_mma16168_s2_1d<128, 2,
                                                                     64>(
...
REGISTER_KERNEL(
    ...
    felix::make_flash_attn_kernel(
        "sm80_flash_attn_f16_hd128_bq64_bk64_mma16168_s2_1d",
        felix::sm80_flash_attn_f16_hd128_bq64_bk64_mma16168_s2_1d_launch, true,
        {.min_cc = 80,
         .max_cc = 89,
         .priority = 50,
