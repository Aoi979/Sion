...
felix::ampere_flash_attn_mma16168_64_1D_warp_tiling_kernel_launch<64, 2, 64>(
    half *, half *, half *, half *, uint32_t, uint32_t, uint32_t,
    cudaStream_t);
template felix::FelixStatus
felix::ampere_flash_attn_mma16168_64_1D_warp_tiling_kernel_launch<128, 2, 64>(
    half *, half *, half *, half *, uint32_t, uint32_t, uint32_t,
    cudaStream_t);
...
REGISTER_KERNEL(
    flash_attn_128,
    (felix::KernelEntry{
        felix::KernelType::FlashAttn_128,
        "ampere_flash_attn_mma16168_64_1D_warp_tiling",
        (void *)
            felix::ampere_flash_attn_mma16168_64_1D_warp_tiling_kernel_launch<
                128, 2, 64>,
