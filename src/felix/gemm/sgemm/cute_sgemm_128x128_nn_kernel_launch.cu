#include "kernels/cute_sgemm_128x128_naive.cuh"
#include <felix/felix.hpp>
#include <felix/registry.hpp>
namespace felix {

FelixStatus cute_sgemm_128x128_nn_kernel_launch(uint32_t m, uint32_t n,
...
REGISTER_KERNEL(cute_sgemm_128x128_nn,
                (felix::KernelEntry{
                    felix::KernelType::SGEMM, "cute_sgemm_128x128_nn",
                    (void *)felix::cute_sgemm_128x128_nn_kernel_launch,
                    false}));
