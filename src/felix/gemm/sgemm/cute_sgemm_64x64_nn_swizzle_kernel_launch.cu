...
namespace felix {
FelixStatus cute_sgemm_64x64_nn_swizzle_kernel_launch(uint32_t m, uint32_t n,
...
REGISTER_KERNEL(cute_sgemm_64x64_nn_swizzle,
                (felix::KernelEntry{
                    felix::KernelType::SGEMM, "cute_sgemm_64x64_nn_swizzle",
                    (void *)felix::cute_sgemm_64x64_nn_swizzle_kernel_launch, false}));
