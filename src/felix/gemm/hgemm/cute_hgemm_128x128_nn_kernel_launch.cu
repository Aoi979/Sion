...
FelixStatus cute_hgemm_128x128_nn_kernel_launch(uint32_t m, uint32_t n,
...
REGISTER_KERNEL(cute_hgemm_128x128_nn,
                (felix::KernelEntry{
                    felix::KernelType::HGEMM, "cute_hgemm_128x128_nn",
                    (void *)felix::cute_hgemm_128x128_nn_kernel_launch,
                    false}));
