...
FelixStatus cuda_topk_f32_radix_select_launch(const float *data, float *out,
                                               uint32_t num_slices,
...
REGISTER_KERNEL(
    ...
    felix::make_topk_kernel("cuda_topk_f32_radix_select",
                            felix::cuda_topk_f32_radix_select_launch,
                            false));
